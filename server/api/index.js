...
router.get("/weather", async (req, res) => {
    ...
    // Fixing the params of zipcode and tempImperial for an example GET request
    let weatherData = await weather.getWeatherData(98052, "us");

    // Content that will be sent will be prettified JSON
...
router.post("/weather", async (req, res) => {
    ...
    // The params for zipCode and tempImperial are dynamic
